"""
REINFORCE family of policy-gradient methods.
...
from src.deep.networks import PolicyNetwork, ValueNetwork


class UniversalAgent:
    def __init__(self, mode, state_dim, action_dim, lr=0.005, gamma=0.99,
                 hidden_size=128, entropy_coef=0.01):
...
def train_agent(mode, seed=42, episodes=500, lr=0.005, entropy_coef=0.01):
    ...
    agent = UniversalAgent(mode, state_dim, action_dim, lr=lr, entropy_coef=entropy_coef)
    scores = []
